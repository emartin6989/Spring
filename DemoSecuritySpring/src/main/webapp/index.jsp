...
<body>
	...
	<div class="conTenu">
		...
		<div class="logoObjis">
			<a href='http://www.objis.com' target=_blank><img
				src="logo_objis.png" border=0
				alt="Objis : spécialiste formation JAVA" border="0"></a>
		</div>
		...
		<security:authorize access="hasRole('ROLE_PARTICIPANT')">
			<div class="mnuLien1">
		...
		<security:authorize access="hasRole('ROLE_FORMATEUR')">
			<div class="mnuLien1">
		...
		<security:authorize access="hasRole('ROLE_MAINTENANCE')">
			<div class="mnuLien1">
	...
	<div class="copyRight">
		Copyright <a href='http://www.objis.com'>Objis formations :
			www.objis.com</a>
	</div>
</body>
</html>